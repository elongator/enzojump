...
class PreloadScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('obsticle-2', 'assets/cactuses_small_1.png')
        this.load.image('obsticle-3', 'assets/cactuses_small_1.png')
        this.load.image('obsticle-4', 'assets/cactuses_small_1.png')
        this.load.image('obsticle-5', 'assets/cactuses_small_1.png')
        this.load.image('obsticle-6', 'assets/cactuses_small_1.png')
    }
